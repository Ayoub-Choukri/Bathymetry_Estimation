...
def run_vda(path) : 
    ...
    freq_obs = 1 # = 1 for all # MAY BE CHANGED
    ...
    prior_depth = np.mean(Hobs_np - bathy_t_np) # PRIOR TO BE TUNED
    bathy_1st_np = Hobs_np - 1 * prior_depth # - (Hobs_np[0]-bathy_t_np[0]) * 1.5 
    b_b_np = bathy_1st_np
    # bathy_1st_np = bathy_t_np # - (Hobs_np[0]-bathy_t_np[0]) * 1.5 
    ...
    regul_term = 'grad' # regularization term form 
